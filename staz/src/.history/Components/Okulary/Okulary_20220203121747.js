  ...
  return (
    <div className="Okulary">
      ...
      >
        ...
        >
          <img src={newItem.Okulary1.image} width="250px" height="250px" />
          <h3>{newItem.Okulary1.name}</h3>
          <h3>Cena: {newItem.Okulary1.price} zł</h3>
          <Button
            variant="outlined"
            onClick={addToCart}
        ...
        >
          <img src={newItem.Okulary2.image} width="250px" height="250px" />
          <h3>{newItem.Okulary2.name}</h3>
          <h3>Cena: {newItem.Okulary2.price} zł</h3>
          <Button
            variant="outlined"
            onClick={addToCart}
            style={{ borderColor: "#af24ff", color: "#af24ff" }}
        ...
        >
          <img src={newItem.Okulary3.image} width="250px" height="250px" />
          <h3>{newItem.Okulary3.name}</h3>
          <h3>Cena: {newItem.Okulary3.price} zł</h3>
          <Button
            variant="outlined"
            onClick={addToCart}
            style={{ borderColor: "#af24ff", color: "#af24ff" }}
