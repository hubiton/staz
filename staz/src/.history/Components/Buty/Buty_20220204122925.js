...
export const Buty = () => {
  var newItems = {
    Buty1: {
      name: "Buty1",
      image:
        "https://images-ext-2.discordapp.net/external/CclIBzBoXWafTIuY2rDEyuvoETE7H8GQXW7QUTQJYrY/https/o.remove.bg/downloads/3d4232d0-a969-4c63-bfad-fbc9bedb9211/i-buty-sportowe-nike-jordan-access-ar3762-001-r-43-removebg-preview.png?width=284&height=300",
      price: "599.99",
    },
    Buty2: {
      name: "Buty2",
