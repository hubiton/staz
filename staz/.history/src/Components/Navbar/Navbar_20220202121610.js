        ...
        <div className="Navbar">
          <div className="Text">
            <ul className="list">
              ...
              >
                <Link to="/" style={{ color: 'inherit', textDecoration: 'inherit' }}><div className="Home"><HomeIcon/>Home</div> </Link>
              </li>
              <li
                // className={
              ...
              <li className="cart">
              <Link to="/cart" style={{ color: 'inherit', textDecoration: 'inherit' }}><ShoppingCartIcon/></Link>
              </li>
            </ul>
          </div>
        </div>
