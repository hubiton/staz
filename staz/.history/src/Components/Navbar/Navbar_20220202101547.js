        ...
        <div className="Navbar">
          <div className="Text">
            <ul className="list">
              ...
              >
                <Link to="/buty" style={{ textDecoration: 'none' }}>buty</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Kurtki" style={{ textDecoration: 'none' }}>Kurtki</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Spodnie" style={{ textDecoration: 'none' }}>Spodnie</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Bluzy" style={{ textDecoration: 'none' }}>Bluzy</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Czapki" style={{ textDecoration: 'none' }}>Czapki</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Szale" style={{ textDecoration: 'none' }}>Szale</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Rekawiczki" style={{ textDecoration: 'none' }}>Rękawiczki</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Okulary" style={{ textDecoration: 'none' }}>Okulary</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Maseczki" style={{ textDecoration: 'none' }}>Maseczki</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Koszulki" style={{ textDecoration: 'none' }}>Koszulki</Link>
              </li>
            </ul>
          </div>
        </div>
