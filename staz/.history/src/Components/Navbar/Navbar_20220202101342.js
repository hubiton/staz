        ...
        <div className="Navbar">
          <div className="Text">
            <ul className="list">
              ...
              >
                <Link to="/Rekawiczki">Rękawiczki</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Maseczki">Maseczki</Link>
              </li>
              <li
                className={
              ...
              >
                <Link to="/Koszulki">Koszulki</Link>
              </li>
            </ul>
          </div>
        </div>
