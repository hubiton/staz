        ...
        <div>
          <Grid item>
            <Button
              onClick={handleOpen}
              variant="outlined"
              style={{ borderColor: "#af24ff", color: "#af24ff", marginRight:"50px", marginLeft:"-25px"}}
            >
          ...
          >
            <Box sx={style}>
              ...
              {animation ? (
               <img src="https://i.postimg.cc/Z5Jw9dZS/output-onlinegiftools-1.gif" width="350px" height="250px"/>
              ) : null}
            </Box>
          </StyledModal>
